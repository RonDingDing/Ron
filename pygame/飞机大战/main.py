...
pygame.display.set_caption("飞机大战 Ron版")
...
def main():
    ...
    while running:
        ...
        #h绘制游戏结束画面
            ...
            # 绘制结束画面
            record_score_text = score_font.render("Best : %d" % score, True, (255, 255, 255))
